...
class PokemonDetailModel {
  ...
  get bgColor => types != null ? ColorsUtil.getColorByType(types!.first) : Colors.cyan;
}
...
class Sprites {
  ...
  Sprites({this.backDefault, this.frontDefault, this.other, this.versions});
